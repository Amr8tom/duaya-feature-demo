...
class HealthGoalsTracking extends StatefulWidget {
  const HealthGoalsTracking({super.key});

  @override
  State<HealthGoalsTracking> createState() => _HealthGoalsTrackingState();
}

class _HealthGoalsTrackingState extends State<HealthGoalsTracking> {
      ...
      body: Column(
        ...
        children: [
          CustomSwitchListTitleWidget(
            title: S.current.set_health_goals,
            value: emailLogin,
          ...
          CustomSwitchListTitleWidget(
            title: S.current.track_health_goals_progress,
            value: socialLogin,
            onChanged: (bool value) {
              setState(() {
                socialLogin = value;
