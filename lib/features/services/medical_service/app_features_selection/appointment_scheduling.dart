...
class AppointmentScheduling extends StatefulWidget {
  const AppointmentScheduling({super.key});

  @override
  State<AppointmentScheduling> createState() => _AppointmentSchedulingState();
}
      ...
      body: Column(
        ...
        children: [
          CustomSwitchListTitleWidget(
            title: S.current.book_appointments,
            value: emailLogin,
          ...
          CustomSwitchListTitleWidget(
            title: S.current.appointment_reminders,
            value: socialLogin,
            onChanged: (bool value) {
              setState(() {
                socialLogin = value;
