...
class DoctorPatientCommunication extends StatefulWidget {
  const DoctorPatientCommunication({super.key});

  @override
  State<DoctorPatientCommunication> createState() =>
      _DoctorPatientCommunicationState();
}

class _DoctorPatientCommunicationState
    extends State<DoctorPatientCommunication> {
      ...
      body: Column(
        ...
        children: [
          CustomSwitchListTitleWidget(
            title: S.current.enable_secure_messaging,
            value: emailLogin,
          ...
          CustomSwitchListTitleWidget(
            title: S.current.video_consultations,
            value: socialLogin,
            onChanged: (bool value) {
              setState(() {
                socialLogin = value;
