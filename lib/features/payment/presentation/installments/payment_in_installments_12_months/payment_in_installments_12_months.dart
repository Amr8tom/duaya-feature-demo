...
class PaymentInInstallments12Months extends StatelessWidget {
  const PaymentInInstallments12Months({super.key});

  @override
  Widget build(BuildContext context) {
    final paymentController = context.read<PaymentCubit>();
    paymentController.changePaymentMethod(paymentMethodID: 6, context: context);
